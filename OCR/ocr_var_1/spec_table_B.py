...
def spec_table_B(idir, image_full_path, new_coord_line, new_coord_box, order):
    ...
    if "price" in key_blocks_B:
        ...
        if len(landclass_level) == 0:
            ...
            with open(r"C:/Users/brigs/Desktop/results/spec_errors_landclass_level.txt", 'a') as f:
                f.write("\n")
                f.write(err_note)
        else:
        ...
        if len(price_level) == 0:
            ...
            with open(r"C:/Users/brigs/Desktop/results/spec_errors_price_level.txt", 'a') as f:
                f.write("\n")
                f.write(err_note)
        else:
        ...
        if len(daejikwon_level) == 0:
            ...
            with open(r"C:/Users/brigs/Desktop/results/spec_errors_daejikwon_level.txt", 'a') as f:
                f.write("\n")
                f.write(err_note)  
        else:
        ...
        if len(soyoukwon_level) == 0:
            ...
            with open(r"C:/Users/brigs/Desktop/results/spec_errors_soyoukwon_level.txt", 'a') as f:
                f.write("\n")
                f.write(err_note)
        else:
        ...
        if len(B_list)==0:
            ...
            with open(r"C:/Users/brigs/Desktop/results/spec_errors.txt", 'a') as f:
                f.write("\n")
                f.write(berr_note)
    ...
    #except:
        ...
        #    with open(r"C:/Users/brigs/Desktop/results/spec_B_errors.txt", 'a') as s:
        #        s.write("\n")
        #        s.write(str(sne))
